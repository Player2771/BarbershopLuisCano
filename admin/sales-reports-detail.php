...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Reportes de ventas</h3>
...
$y2=date("Y",$month2);
    ?>
<h4 class="header-title m-t-0 m-b-30">Reporte de ventas por mes </h4>
<h4 align="center" style="color:blue">Ventas desde <?php echo $m1."-".$y1;?> Hasta  <?php echo $m2."-".$y2;?></h4>
<hr />
